    ...
    <>
     <main>
      <div className="images">
        ...
        <img id='Louise' src="/Louise phone.png" alt="" />
     ...
     <section id='section1'>
      <nav>
        ...
        <div className="nav-elem">
         <i className="ri-arrow-right-s-line"></i> Our Show Reels
        </div>
        <div className="nav-elem">
      ...
      <div className="bottom">
        ...
        <div className="right">
          <p>Foxstudio is a multidiscipilinary <br />creative studio at the intersection  <br /> of art,desgin and technology </p>
        </div>
      </div>
     ...
     <section id='section2'>
      <div className="titles">
        ...
        <div img-title="red" className="title">
          <small>2020 - ONGOING</small>
     ...
     <section id='section3'>
      <div className="top">
        <div className="left">
          <h3>We're crafting emotional <br /> experiences aimed at <br /> improving results</h3>
        </div>
        <div className="right"></div>
      </div>
     </section>
